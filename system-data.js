...
/* Malta- og DNB-malene er fjernet herfra (sikkerhetsgjennomgang, fase 3): de bar
   innhold fra ekte avtaler, og filen serveres offentlig. De ligger i databasen hos
   selskapet som eier dem. De generelle malene under er bare lister over slidetyper. */
export const BUILTIN_TEMPLATES = ['master', 'simple', 'media', 'blank', 'catalog'];
...
/* Tom med vilje (fase 3). Flettingen la før hver kategori herfra inn hos hvert
   selskap ved innlogging, så Skagerrak fikk «Malta» og Heroic fikk Skagerraks.
   Kategoriene eies av databasen, per selskap. */
